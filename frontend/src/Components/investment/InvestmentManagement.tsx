    ...
    <div className="container mx-auto  mt-16 md:mt-0 px-4 py-8">
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="flex cursor-pointer items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-accent text-white rounded-lg shadow-lg hover:shadow-xl transition-all"
        ...
        <div className="p-4 border-b border-border">
          ...
          {filteredInvestments.length === 0 && (
            <div className="  flex  items-center justify-center">
              <h1 className="font-medium text-red-600  ">No investments found.</h1>
            </div>
          )}
        </div>
        <Suspense>
