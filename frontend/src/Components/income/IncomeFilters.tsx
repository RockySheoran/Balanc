...
const IncomeFilters = () => {
  ...
  const handleSortChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    dispatch(setFilter({ sort: e.target.value as any }))
  }
  ...
  return (
    <motion.div
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
        <h2 className="text-xl font-semibold text-indigo-800 mb-2 md:mb-0">
          Filter Income
        </h2>
        <button
          onClick={handleReset}
          className="px-3 py-1 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition duration-200 text-sm">
          Reset Filters
        </button>
      </div>
